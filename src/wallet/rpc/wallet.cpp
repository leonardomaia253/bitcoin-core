...
RPCHelpMan gethdkeys()
{
    return RPCHelpMan{
        ...
        {
            {"options", RPCArg::Type::OBJ_NAMED_PARAMS, RPCArg::Optional::OMITTED, "", {
                {"active_only", RPCArg::Type::BOOL, RPCArg::Default{true}, "Show the keys for only active descriptors"},
                {"private", RPCArg::Type::BOOL, RPCArg::Default{true}, "Show private keys"}
            }},
        },
